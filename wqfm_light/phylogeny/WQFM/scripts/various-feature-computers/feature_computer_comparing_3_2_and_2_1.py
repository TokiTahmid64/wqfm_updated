...
F1,F2,F3,F4,F5,F6,F7 = find_stats(sys.argv[1], THRESHOLD_TWO_QUARTETS=0.5, THRESHOLD_THREE_QUARTETS=0.6667) # Explanation will be provided.

str_to_write = str(F5) + " "+ str(F6) + " "+ str(F7)
