...
def find_stats(inputFile, THRESHOLD_TWO_QUARTETS=0.1, THRESHOLD_THREE_QUARTETS=0.15):
    ...
    F6 = (sums[5]/sums[2])
    F7 = (sums[6]/sums[2])
    return F1,F2,F3,F4,F5,F6,F7,mode[0]




F1,F2,F3,F4,F5,F6,F7,m = find_stats(sys.argv[1], THRESHOLD_TWO_QUARTETS=0.5, THRESHOLD_THREE_QUARTETS=0.6667) # Explanation will be provided.

str_to_write = str(m[0]) 
